...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? "#FA0" : "#FA0",
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? "#737373" : "#bfc6ea",
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? "#FA0" : "#fff",
  sTabBarActiveTextColor: "#FA0",
  tabBarActiveTextColor: platform === PLATFORM.IOS ? "#2874F0" : "#fff",
  tabActiveBgColor: platform === PLATFORM.IOS ? "#FA0" : "#3F51B5",
